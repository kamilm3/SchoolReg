...
begin
    ...
    select 
        c2.CourseID as ConflictingCourseID,
        c2.CourseName as ConflictingCourseName,
        c2.DayOfWeek,
        c2.StartTime,
        c2.EndTime
    ...
    and (
        (c1.StartTime >= c2.StartTime and c1.StartTime < c2.EndTime)  -- Overlaps at the start
        or
        (c1.EndTime > c2.StartTime and c1.EndTime <= c2.EndTime)  -- Overlaps at the end
        or
        (c1.StartTime <= c2.StartTime and c1.EndTime >= c2.EndTime))  -- One course fully overlaps another
    and (exists (
